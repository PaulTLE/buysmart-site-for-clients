...
<header class="site-header">
  <div class="container header-inner">
    <a class="brand" href="/">
      <span class="brand-mark">BuySmart</span>
...
<footer class="site-footer">
  <div class="container footer-inner">
    <div>
      <div class="brand-mark footer-brand">BuySmart</div>
...
<div class="admin-shell">
  <aside class="admin-sidebar">
    <div class="admin-brand">BuySmart<span>Admin</span></div>
...
function render_propertyDetail({ property, related }) {
  ...
  <section class="detail-hero">
    <div class="container">
      ...
      <h1 style="color:#fff;">${esc(property.title)}</h1>
      <p style="color:#c6cde0;">${esc(property.suburb)}, ${esc(property.state)} ${esc(property.postcode)}</p>
      <div style="font-size:26px;font-weight:800;color:#e0c25f;">${priceLabel(property)}</div>
    </div>
  </section>
  <section class="section">
    <div class="container">
